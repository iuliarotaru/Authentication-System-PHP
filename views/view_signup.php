...
<div class="signup_main">
    ...
    <form id="signup_form" enctype="multipart/form-data">
        ...
        <div class="form_element">
            ...
            <input name="user_name" id="user_name" type="text" placeholder="name" onclick="clear_error()" maxlength="20" data-validate="str" data-min="2" data-max="20">
        </div>
        <div class="form_element">
            <label for="user_last_name">Last name <span class="soft">Minimum 2 maximum 20 characters</span></label>
            <input name="user_last_name" id="user_last_name" type="text" placeholder="last name" onclick="clear_error()" maxlength="20" data-validate="str" data-min="2" data-max="20">
        </div>
        <div class="form_element">
            <label for="user_email">Email <span class="soft">enter a valid email</span></label>
            <input name="user_email" id="user_email" type="email" placeholder="email" onclick="clear_error()" data-validate="email">
        </div>
        <div class="form_element">
            <label for="user_phone">Phone <span class="soft">8 digits</span></label>
            <input name="user_phone" id="user_phone" type="tel" placeholder="phone number" onclick="clear_error()" data-validate="int" data-min="10000000 " data-max="99999999">
        </div>
        <div class="form_element">
