...
try{
    ...
    $q = $db->prepare("INSERT INTO users VALUES (:user_uuid, :user_name, :user_last_name, :user_email, :user_phone, :user_password, :user_active, :user_token, :user_verified, :user_image_path)");
    for($i = 0; $i < 15; $i++){
      ...
      $q->bindValue(':user_image_path', 'image.png');
      $q->execute();
    }  
